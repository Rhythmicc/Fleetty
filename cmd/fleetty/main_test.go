	...
	model := &hubModel{
		...
		slurmStates: []slurmClusterState{{Snapshot: slurmSnapshot{
			...
			Jobs: []slurmJob{
				...
				{ID: "101", Partition: "rtx5060", State: "PENDING", Priority: 60000, QOS: "long", Name: "later", Reason: "(Resources)"},
				{ID: "7", Partition: "rtx5060", State: "RUNNING", Priority: 50000, QOS: "normal", Name: "active", NodeList: "node[1-3]"},
			},
		}}},
	}
